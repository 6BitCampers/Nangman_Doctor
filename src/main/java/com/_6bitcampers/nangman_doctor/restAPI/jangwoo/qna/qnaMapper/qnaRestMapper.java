...
public interface qnaRestMapper {
    ...
    @Select("select comment_comment,qna_no,he.employee_nickname from board_comment bc join semi.hospital_employee he on he.employee_no = bc.employee_no where qna_no=#{qna_no}")
